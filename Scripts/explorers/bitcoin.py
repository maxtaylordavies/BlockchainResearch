...
def scrapePageOfBlocks(p, headers):
    url = "https://btc.tokenview.com/api/blocks/btc/%d/100" % p
...
def scrapeBlocks():
    ...
    while True:
        ...
        if p % 10 == 0:
            with open(baseDir + "/Data/OtherChains/bitcoin/historical_blocks.csv", "a") as dest:
            ...
            with open(baseDir + "/Logs/bitcoin/blocks.txt", "a") as logfile:
