...
def scrapePageOfBlocks(p, headers):
    url = "https://xvg.tokenview.com/api/blocks/xvg/%d/1000" % p
...
def scrapeBlocks():
    ...
    while True:
        ...
        if p % 10 == 0:
            with open(baseDir + "/Data/OtherChains/verge/historical_blocks.csv", "a") as dest:
            ...
            with open(baseDir + "/Logs/verge/blocks.txt", "a") as logfile:
