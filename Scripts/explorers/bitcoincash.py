...
def scrapePageOfBlocks(p, headers):
    url = "https://bch.tokenview.com/api/blocks/bch/%d/100" % p
...
def scrapeBlocks():
    ...
    while True:
        ...
        if p % 10 == 0:
            with open(baseDir + "/Data/OtherChains/bitcoincash/historical_blocks.csv", "a") as dest:
            ...
            with open(baseDir + "/Logs/bitcoincash/blocks.txt", "a") as logfile:
