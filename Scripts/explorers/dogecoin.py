...
def scrapePageOfBlocks(p, headers):
    url = "https://doge.tokenview.com/api/blocks/doge/%d/100" % p
...
def scrapeBlocks():
    ...
    while True:
        ...
        if p % 10 == 0:
            with open(baseDir + "/Data/OtherChains/dogecoin/historical_blocks.csv", "a") as dest:
            ...
            with open(baseDir + "/Logs/dogecoin/blocks.txt", "a") as logfile:
